...
export const RHYTHM_YOU_CAN_SEE_LESSONS = [
  ...
  },
  {
    ...
    audio: {
      body: "Compare eight even positions with late “ands” that squeeze the following numbered beats.",
      correctLabel: "Even number-and split",
      incorrectLabel: "Late ands, rushed next beats",
      correctPattern: {
        kind: "rhythm",
        subdivisions: 8,
      ...
      incorrectPattern: {
        ...
        events: [
          { timeBeats: 0, accented: true },
          { timeBeats: 0.68 },
          { timeBeats: 1, accented: true },
          { timeBeats: 1.68 },
          { timeBeats: 2, accented: true },
          { timeBeats: 2.68 },
          { timeBeats: 3, accented: true },
          { timeBeats: 3.68 },
        ],
        bpm: 60,
      },
  ...
  },
  {
    ...
    audio: {
      body: "The hand motion itself is visual. Hear its usual timing result beside delayed upstrokes caused by stopping and restarting.",
      correctLabel: "Even result of continuous motion",
      incorrectLabel: "Uneven restart delays",
      correctPattern: {
        kind: "rhythm",
        subdivisions: 8,
        activeSteps: [0, 1, 2, 3, 4, 5, 6, 7],
      ...
      listenFor: "The correct audio has equal number-and spacing; use the visual to check that your hand also keeps moving through it.",
    },
    guidedPractice: {
